    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Center: Search Bar (Hamesha Bahar Rahega - Responsive) */}
      ...
      {/* Global Full-Width Dropdown Menu (Screen ke left to right poora stretch hoga) */}
      <div
        className={`absolute left-0 w-full top-16 bg-white shadow-xl border-t border-gray-100 py-3 pb-4 space-y-1 transition-all duration-300 ease-in-out z-40 origin-top ${
          menuOpen
