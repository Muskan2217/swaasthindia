...
import { Search, ChevronDown, PhoneCall } from "lucide-react";
import {
  specializations,
  experienceRanges,
  availabilityOptions,
    ...
    <aside className="space-y-6">
      ...
      <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-5">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Request a callback and we&apos;ll help you find the right
          specialist.
        </p>
        <button
          type="button"
          className="mt-4 inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 shadow-sm transition hover:bg-blue-50"
        >
