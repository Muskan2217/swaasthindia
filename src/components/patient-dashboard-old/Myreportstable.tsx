        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1 sm:flex-initial">
            ...
            <input
              ...
              className="w-full sm:w-44 pl-8 pr-3 py-2 text-sm border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300"
            />
          </div>
          {/* Filter */}
          <button className="flex items-center gap-1.5 px-3 py-2 text-sm text-gray-600 border border-gray-400 rounded-xl hover:bg-gray-50 transition-colors">
        ...
        <table className="w-full">
          <thead>
            <tr className=" border-b border-gray-200">
              <th className="text-left text-xs font-semibold text-gray-600 pb-3 pr-4">Test Name</th>
              <th className="text-left text-xs font-semibold text-gray-600 pb-3 pr-4">Date</th>
              <th className="text-left text-xs font-semibold text-gray-600 pb-3 pr-4">Status</th>
              <th className="text-left text-xs font-semibold text-gray-600 pb-3">Action</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((report) => (
